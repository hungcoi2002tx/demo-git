                                    ...
                                    <tbody>
                                        <c:forEach items="${list_Product}" var="c">
                                            ...
                                            <tr>
                                                ...
                                                <td>${c.getQuantity()}</td>
                                                <td>
                                                    <a href="productdetail?mode=update&id=${c.getId()}" class="btn btn-secondary btn-sm " tabindex="-1" role="button" aria-disabled="true">Update</a>
                                                    <a href="productdetail?mode=delete&id=${c.getId()}" class="btn btn-danger btn-sm " tabindex="-1" role="button" aria-disabled="true">Delete</a>
                                                </td>
                                            </tr>
